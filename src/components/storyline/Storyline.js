      ...
      <div>
        ...
        <div>
          <ul className="details-noList">
            ...
            <li>
              <p>
                ...
                {(title.production_companies || [])
                  .map((prodCompanies) => prodCompanies.name)
                  .join(', ')}
              </p>
            </li>
            <li>
              <p>
                Genre {(title.genres || []).map((gen) => gen.name).join(', ')}
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                ...
                {(title.spoken_languages || [])
                  .map((languages) => languages.name)
                  .join(', ')}
              </p>
            </li>
            {title.first_air_date && (
              <li>
                <p>First Aired {title.first_air_date}</p>
              </li>
            )}
            ...
            {title.last_air_date && (
              <li>
                <p>Last Aired {title.last_air_date}</p>
              </li>
            )}
          </ul>
